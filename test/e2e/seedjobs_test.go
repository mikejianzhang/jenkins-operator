...
import (
	...
	"github.com/mikejianzhang/jenkins-operator/internal/render"
...
if(jobRef.getScm().getRepositories().find { it.getURIs().find { uri -> uri.toString().equals("https://github.com/mikejianzhang/jenkins-operator.git") } } == null) {
